...
export class GatewayMetrics {
  ...
  render(): string {
    ...
    const lines = [
      ...
      "# HELP multi_agent_gateway_queued_runs Current generations waiting for a worker slot.",
      "# TYPE multi_agent_gateway_queued_runs gauge",
      `multi_agent_gateway_queued_runs ${stats.queuedRuns}`,
